...
| HJ-011 v1.8 | Epic 1 Vendor Registration Implementation Scope | Approved | Active implementation boundary aligned to CON-013–CON-017, CON-019, amended CON-020 and CON-028. |
...
| HJ-107 v1.5 | Vendor Registration Test Catalogue | Approved | Current approved behavioural-verification catalogue; regeneration is required after amended CON-020 reaches HJ-106. |
| HJ-013 v1.7 | Architecture and Implementation Test Catalogue | Approved | Current approved architecture and implementation verification catalogue; regeneration is required after HJ-107. |
...
| **Authoritative Scope** | HJ-011 v1.8 |
...
The current concern set covers the complete executable boundary established by HJ-011 v1.8 and HJ-SM-001 v1.0:
...
| **Approved concerns retained** | CON-001–CON-017, CON-027, CON-028 and CON-040. CON-014–CON-016 and CON-028 are newly reconciled from explicit approval evidence. |
| **HJ-012 synchronization** | Twenty-two Approved concerns are represented in the synchronized HJ-012 v1.8 baseline. |
| **Blocked concern dependencies** | CON-020, CON-024 and CON-025 identify their blocking concerns and/or missing authoritative sources in Decision Treatment / Source. CON-018–CON-021 and CON-029 retain responsibility for relay, event-contract, broker-delivery and migration-lifecycle mechanics. |
...
| **Reconciliation date** | 19 August 2026; CON-013 reconciliation |
