...
internal static class VendorRegistrationRecordMapper
{
    public static VendorRegistrationRecord ToRecord(VendorAggregate vendor)
    {
        ...
        return new VendorRegistrationRecord
        {
            ...
            WeeklyOpeningHours = characteristics.WeeklyOpeningHours.Days
                .Select(day => new VendorOpeningHoursRecord
                {
                    VendorId = vendor.Id.Value,
                    Day = ToPersistenceValue(day.Day),
        ...
        var registrationInformation = new VendorRegistrationInformation(
            ...
            new TradingCharacteristics(
                ...
                new WeeklyOpeningHours(
                    record.WeeklyOpeningHours.Select(ToDomain)),
    ...
    private static string ToPersistenceValue(TradingDay value) => value switch
    {
    ...
    private static DailyOpeningHours ToDomain(VendorOpeningHoursRecord value)
    {
        TradingDay day = value.Day switch
        {
            "monday" => TradingDay.Monday,
            "tuesday" => TradingDay.Tuesday,
            "wednesday" => TradingDay.Wednesday,
            "thursday" => TradingDay.Thursday,
            "friday" => TradingDay.Friday,
            "saturday" => TradingDay.Saturday,
            "sunday" => TradingDay.Sunday,
            _ => throw UnsupportedValue(nameof(VendorOpeningHoursRecord.Day), value.Day)
        };
        ...
        return value switch
        {
            ...
            _ => throw new InvalidOperationException(
                $"Stored opening-hours state for '{value.Day}' is invalid.")
        };
    }
